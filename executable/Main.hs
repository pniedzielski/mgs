...
main = do
  ...
  putStrLn . Tree.drawTree . derivationTree . head $ concatMap (derivations df) (doneItems chart 'c' 4)
  ...
  putStrLn . Tree.drawTree . derivationTree . head $ concatMap (derivations df') (doneItems chart' 'd' 6)
